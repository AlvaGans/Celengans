...
const LogoIcon = () => (
    <div 
        style={{
            backgroundImage: `url("https://www.google.com/imgres?q=logo%20celengan%20yang%20bisa%20mengelola%20celengan%20banyak%20orang&imgurl=https%3A%2F%2Fimage.idn.media%2Fpost%2F20180721%2Fa9a96e32210d9a5d929ce242fa866e33.jpg&imgrefurl=https%3A%2F%2Fwww.idntimes.com%2Flife%2Finspiration%2Fmulai-dilupakan-menabung-di-celengan-ternyata-banyak-keuntungannya-01-zd8v5-ckp5xd&docid=zQbE5XFUIt9baM&tbnid=J3aN-dozxdq0ZM&vet=12ahUKEwiJj9zb-cGPAxV9RCoJHcFPEqUQM3oECB0QAA..i&w=1024&h=670&hcb=2&ved=2ahUKEwiJj9zb-cGPAxV9RCoJHcFPEqUQM3oECB0QAA")`,
        ...
        className="h-10 w-10"
        role="img"
        aria-label="Celengan Berbasis Website"
    />
);
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4">
            <div className="w-full max-w-md">
                 <div className="flex justify-center items-center mb-6 space-x-3">
                    <LogoIcon />
                    <h1 className="text-3xl font-bold text-gray-800">Celengan Alva07</h1>
                </div>
...
const SuperuserDashboard = ({ users, transactions }) => {
    ...
    const handleGenerateSummary = async () => {
        ...
        const prompt = `Anda adalah seorang bendahara untuk program tabungan komunitas "Celengan DWP Alva". Total dana terkumpul saat ini adalah ${formatCurrency(totalKas)}. Berdasarkan data total setoran (bukan penarikan) per bulan berikut: ${dataString}, buatlah ringkasan singkat (2-3 kalimat) dalam Bahasa Indonesia yang informatif dan positif. Sebutkan total dana terkumpul yang benar, identifikasi bulan dengan setoran tertinggi, dan berikan kalimat penyemangat.`;
    ...
    const handleGenerateAnnouncement = async () => {
        ...
        setAnnouncement('');
        const prompt = `Buatkan draf pengumuman singkat (1-2 paragraf) untuk anggota komunitas tabungan "Celengan Alva07". Sampaikan informasi berikut dengan gaya bahasa yang ramah dan memotivasi: 
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 md:h-20">
                        <div className="flex items-center space-x-3">
                            <LogoIcon />
                            <span className="text-xl font-bold text-gray-800">Celengan Alva07</span>
                        </div>
